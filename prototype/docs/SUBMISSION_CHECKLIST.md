...
- [x] Static journey completes without a key.
- [x] Evidence, counter-evidence, freshness, and provenance are visible.
- [x] Rexona, Dove, and Axe are compared.
- [x] Geography and rights controls change Preparedness and route.
- [x] Sprint rules lock before the result.
- [x] Rights failure cannot be bypassed.
...
- [x] Stage 1 deadline is 20 August 2026; the supplied PDFs do not state an exact cutoff time or timezone.
- [x] Stage 1 is exactly three slides, and the rulebook describes the upload as a “3-slider PPT solution”; submission destination and portal mechanics are not stated explicitly.
- [x] Official rubric is Product 25%, Ecosystem 20%, AI/Technical Feasibility 20%, Prioritization 15%, Impact 15%, and Creativity/Prototype 5%.
- [x] A prototype is mandatory; submissions without one will not be considered.
- [x] Official case asks are mapped to the three-slide story and prototype in `OFFICIAL_REQUIREMENTS_AUDIT.md`.
...
- [ ] Confirm the deck makes no real-HUL-integration, autonomous-publishing, or unsupported “real-time/first” claim.
