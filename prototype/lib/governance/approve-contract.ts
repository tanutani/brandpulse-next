...
export function hasCurrentVersionApproval(decisions: HumanDecision[], currentVersion: number): boolean {
  return decisions.some((decision) => decision.decision === "approve_test" && decision.contractVersion === currentVersion);
}
